...
Product & strategy person who builds **AI-native tools** — mostly around Claude, Claude Code,
skills/marketplaces, and PM workflows. I like turning rough ideas into working things fast.

🔹 [**playground**](https://github.com/Zeev-L/playground) — my Claude Code skill marketplace ([catalog](https://zeev-l.github.io/playground/))
🔹 [**claude-hebrew-support**](https://github.com/Zeev-L/claude-hebrew-support) — automatic Hebrew/Arabic RTL for Claude (desktop + web)

---

## 📦 My repositories

> This list is generated automatically from my public repositories — it stays current on its own.
...
|------|------------|------|---------|----|
| [skills-marketplace](https://github.com/Zeev-L/skills-marketplace) | Personal Claude Code skill marketplace — 221 skills across 18 plugins. Browse the catalog → https://zeev-l.github.io/playground/ | Python | 2026-07-23 | 0 |
| [marketingskills](https://github.com/Zeev-L/marketingskills) | Corey Haines' SaaS marketing skills (mirror of coreyhaines31/marketingskills.git for my Claude Code marketplace) | JavaScript | 2026-07-23 | 0 |
| [Zeev-L](https://github.com/Zeev-L/Zeev-L) | Profile README | Shell | 2026-07-23 | 0 |
| [my-toolbox](https://github.com/Zeev-L/my-toolbox) | Bilingual (HE/EN) landing page for the tools I install + a live view of my GitHub repos. → https://zeev-l.github.io/my-toolbox/ | HTML | 2026-07-22 | 0 |
| [news-ticker](https://github.com/Zeev-L/news-ticker) | macOS breaking-news ticker — translucent, click-through, draggable bar streaming Israeli news RSS | JavaScript | 2026-07-22 | 0 |
| [focus-timer](https://github.com/Zeev-L/focus-timer) | A small floating focus-timer disc for macOS — glassy, always-on-top, warms in color and counts overtime when you drift past your block. | JavaScript | 2026-07-21 | 0 |
| [rega](https://github.com/Zeev-L/rega) | רגע — a quiet macOS menu-bar companion for work-confidence: vision, mantra, strengths, gratitude, and an automatic evening gratitude email. | JavaScript | 2026-07-21 | 0 |
| [claude-morning-brief](https://github.com/Zeev-L/claude-morning-brief) | Automatic weekday-morning email digest of your parallel Claude Code sessions — what got done, where each stopped, next step — with a one-click "reopen session" button. | JavaScript | 2026-07-16 | 0 |
...
| [claude-jump](https://github.com/Zeev-L/claude-jump) | Tiny https→claudejump:// redirect page for the Morning Brief tool, so email links can reopen a specific Claude Code session in the desktop app. | HTML | 2026-07-05 | 0 |
...
<sub>🤖 The repository list above refreshes daily via a GitHub Action
([workflow](.github/workflows/update-readme.yml) · [generator](scripts/generate-readme.sh)).</sub>
