...
**15 public repositories** · sorted by latest activity · updated automatically

| Repo | What it is | Lang | Updated | ⭐ |
|------|------------|------|---------|----|
| [claude-jump](https://github.com/Zeev-L/claude-jump) | — | HTML | 2026-06-30 | 0 |
| [Zeev-L](https://github.com/Zeev-L/Zeev-L) | Profile README | Shell | 2026-06-29 | 0 |
| [claude-status-monitor](https://github.com/Zeev-L/claude-status-monitor) | macOS menu-bar indicator for parallel Claude Code sessions: red=working, orange=waiting, green=done. Built on Claude Code hooks + SwiftBar. | Python | 2026-06-29 | 0 |
| [the-mic](https://github.com/Zeev-L/the-mic) | Personal automation scripts — Gmail→Sheets task manager | HTML | 2026-06-28 | 0 |
